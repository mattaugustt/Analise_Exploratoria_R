---
Titulo: 'Análise de Dados de Educação Superior'
Autores: Gabriela Oliveira | Niara Gomes | Matheus Augusto
DRE: 119019326 | 124022156 | 118164136
date: "2024-12-05"
output:
...
Este documento fornece uma avaliação fundamentada nas informações de fluxo do ensino superior no Brasil. A avaliação concentra-se em desistências, retenções e correlações.
...
## Estruturando a modalidade de Ensino
...
### Identificação da maior taxa de desistência
...
### Rank dos cursos com maior taxa de desistência (Proporção)
...
### Rank dos cursos com menor taxa de desistência (Valores Absolutos)
...
### Informações sobre os cursos (prazo de acompanhamento, desistências e permanências)
...
### Ordenado pelos cursos com maior quantidade (números absolutos) de permanência
...
### Ordenando pelos cursos com menor quantidade (números absolutos) de permanência
...
## Rank dos cursos pelas taxas

### Ordenando pelos cursos com maior proporção de permanência
...
Não é uma análise que valha a pena ser demonstrada em gráficos, o top10 tem 0%.
...
### Informações sobre as universidades (prazo de acompanhamento, desistências e permanências)
...
## Rank das universidades pelas taxas

### Rank de universidades com menor taxa de permanência
...
### Rank de universidades com maior taxa de permanência
...
## Rankeamento das universidades pelo valor absoluto

### Rank de universidades com menor permanência (valor absoluto)
...
### Rank de universidades com maior permanência (valor absoluto)
...
## Taxa de permanência e desistência por UF

### Rank de UFs com maior taxa de desistência
...
### Rank de regiões com maior taxa de permanência
...
## Valores absolutos de permanência e desistência por UF

### Rank de UFs com maior desistência (valor absoluto)
...
### Rank de UFs com maior permanência (valor absoluto)
...
### Rank de maior permanência pelo tipo de administração
...
### Rank de maior desistência pelo tipo de administração
...
#criando o rank da adm desistencia
...
### Rank de maior permanência pelo tipo de administração (taxa)
...
## Permanência por modalidades valor absoluto
...
## Permanências por modalidade (taxa)
...
### Desistências por modalidade (valor absoluto)
...
### Desistências por modalidade (Taxa)
...
## Correlação entre tipo de instituição(Pública/Privada)
...
## Correlação entre permanências , desistência e tipo de instituição
...
## Correlação entre permanências , desistência e modalidade de ensino
...
## Correlação entre permanências , desistência e região do curso
...
## Correlação entre Desistência, Permanência e a Categoria Administrativa
